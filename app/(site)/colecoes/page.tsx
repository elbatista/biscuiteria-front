...
export default async function CollectionsIndexPage() {
  const [collections, faqItems] = await Promise.all([
    getCollectionsIndexPageData(),
      ...
      <div className="bg-[var(--rose-50)] text-[var(--text-main)]">
        ...
        <Section color="green">
          <Container>
            <FaqPreview
              items={faqItems}
              title="Dúvidas em geral?"
              subtitle="Veja respostas rápidas sobre peças disponíveis, encomendas personalizadas, prazos e envio."
