...
import type {
  PublicStoreSettings,
} from "@/lib/server/public-store-settings";
  ...
  if (
    ...
    return (
      <main className="bg-[var(--rose-50)] text-[var(--text-main)]">
        <Container>
          <div className="space-y-6 py-10">
            <div className="rounded-3xl border border-amber-200 bg-white p-8 sm:p-10">
              <p className="text-sm font-medium uppercase tracking-[0.18em] text-amber-700">
                Pedido
                incompleto
              </p>

              <h1 className="mt-2 font-playfair text-3xl font-semibold tracking-tight text-zinc-900">
                Falta escolher
                a cor de um
                produto
              </h1>
